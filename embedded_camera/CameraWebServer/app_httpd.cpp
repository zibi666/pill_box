...
static esp_err_t capture_handler(httpd_req_t *req)
{
    ...
    if (fb->format == PIXFORMAT_RGB565
     ...
     && !recognition_enabled
        ...
        s = fmt2jpg_cb(fb->buf, fb->len, fb->width, fb->height, PIXFORMAT_RGB565, 60, jpg_encode_stream, &jchunk);
        esp_camera_fb_return(fb);
    } else
    {
        ...
        s = fmt2jpg_cb(out_buf, out_len, out_width, out_height, PIXFORMAT_RGB888, 60, jpg_encode_stream, &jchunk);
        free(out_buf);
    }
